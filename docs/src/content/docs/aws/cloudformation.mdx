...
[**→ Launch Stack in us-east-1**](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/quickcreate?templateURL=https://deepsql-cfn-461084093078-us-east-2.s3.us-east-2.amazonaws.com/deepsql-stack.yaml&stackName=deepsql-selfhost)

To launch in a different region, change `region=us-east-1` to your region (e.g. `region=eu-west-1`). The template is hosted in `us-east-2` but works for stacks in any region.

Direct template URL: `https://deepsql-cfn-461084093078-us-east-2.s3.us-east-2.amazonaws.com/deepsql-stack.yaml`
